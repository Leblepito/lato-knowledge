...
def seed_hotel_db() -> dict:
    ...
    hotels = [
        {"name": "The Brook Pool Resort", "slug": "brook-pool", "rooms": 31,
         ...
         "location": "Choeng Thale, Thalang", "type": "Boutique Resort"},
        {"name": "Trend Kamala", "slug": "trend-kamala", "rooms": 42,
    ...
    staff = [
        {"name": "Somchai Charoenkit", "department": "TEKNIK", "hotel": "brook-pool",
         "role": "Teknik Şef", "nationality": "TH", "wp_expiry": "2026-09-15"},
        {"name": "Nongluck Phromma", "department": "HK", "hotel": "brook-pool",
         "role": "Housekeeping Lider", "nationality": "TH", "wp_expiry": None},
        {"name": "Kanya Suwanno", "department": "FB", "hotel": "brook-pool",
         "role": "Şef Garson", "nationality": "TH", "wp_expiry": None},
        {"name": "Ahmet Yılmaz", "department": "YONETIM", "hotel": "brook-pool",
        ...
        {"name": "Anucha Petchsri", "department": "GUVENLIK", "hotel": "patong-heritage",
         "role": "Güvenlik Amiri", "nationality": "TH", "wp_expiry": None},
        {"name": "Fatma Kaya", "department": "MUHASEBE", "hotel": "brook-pool",
         "role": "Muhasebe Müdürü", "nationality": "TR", "wp_expiry": "2026-11-10"},
        {"name": "Wichai Kaewsing", "department": "FB", "hotel": "kata-sea-view",
         "role": "Aşçıbaşı", "nationality": "TH", "wp_expiry": None},
        {"name": "Hüseyin Şahin", "department": "TEKNIK", "hotel": "rawai-boutique",
         "role": "Bakım Şefi", "nationality": "TR", "wp_expiry": "2026-07-12"},
        {"name": "Niran Jantarak", "department": "HK", "hotel": "surin-beach-villa",
        ...
        {"name": "Alexey Petrov", "department": "ON_BURO", "hotel": "patong-heritage",
         "role": "Guest Relations", "nationality": "RU", "wp_expiry": "2026-06-30"},
        {"name": "Rattana Sornci", "department": "HK", "hotel": "kata-sea-view",
         "role": "Housekeeping", "nationality": "TH", "wp_expiry": None},
        {"name": "Kemal Aydın", "department": "TEKNIK", "hotel": "brook-pool",
         "role": "Havuz Uzmanı", "nationality": "TR", "wp_expiry": "2026-10-01"},
        {"name": "Pim Tantawan", "department": "FB", "hotel": "rawai-boutique",
         "role": "Garson", "nationality": "TH", "wp_expiry": None},
        {"name": "Chai Wongwit", "department": "GUVENLIK", "hotel": "brook-pool",
         "role": "Güvenlik", "nationality": "TH", "wp_expiry": None},
        {"name": "Somporn Laokiat", "department": "TEKNIK", "hotel": "patong-heritage",
    ...
    financial = {
        ...
        "break_even_adr": 684,
        "reconciliation": {
            "brook": {"bank_statement": 303620, "accounting": 129290,
